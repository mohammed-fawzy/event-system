...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash } from 'file://E:/event/event-system/node_modules/ufo/dist/index.mjs';
...
import { createCall, createFetch } from 'file://E:/event/event-system/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://E:/event/event-system/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://E:/event/event-system/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://E:/event/event-system/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://E:/event/event-system/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://E:/event/event-system/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://E:/event/event-system/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://E:/event/event-system/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://E:/event/event-system/node_modules/consola/dist/index.mjs';
import devalue from 'file://E:/event/event-system/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file://E:/event/event-system/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file://E:/event/event-system/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://E:/event/event-system/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://E:/event/event-system/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"E:/event/event-system/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\event\\event-system","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\event\\event-system\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\event\\event-system\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\event\\event-system\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"E:\\event\\event-system\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _u9wD5tFC2E = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "E:/event/event-system";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _JCunINS8Xw = (nitroApp) => {
...
const _lazy_NtQHCO = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_NtQHCO, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_NtQHCO, lazy: true, middleware: false, method: undefined }
];
